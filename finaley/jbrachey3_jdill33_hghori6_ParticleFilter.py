...
class ParticleFilter:
    ...
    def update_for_piece_captured(self, captured_square, playerColor):
        ...
        for particle in self.particles:
            ...
            if len(possible_moves) == 0:
                ...
                #print('push 1')
                # likely_squares = self.get_priority_squares(board, playerColor)

                board.push(possible_moves[0])
                # for square in likely_squares:
    ...
    # def get_priority_squares(self, board, playerColor):
    #     bestMove, bestVal, table = chess_engine.minimax(board, 1, not playerColor)
    #     squares = []
    #     new_table = {}
    #     # print("table: ", table)
    #     # for keys in table:
    #     #     move = table[keys]
    #     #     # print("move: ", move)
    #     #     new_table[move[0]] = move[1]
    #     # if playerColor is True:
    #     #     for i in range(4):
    #     #         move = min(new_table, key = lambda k : new_table.get(k))
    #     #         square = move.to_square
    #     #         squares.append(square)
    #     #         del new_table[move]
    #     # else:
    #     #     for i in range(4):
    #     #         move = max(new_table, key = lambda k : new_table.get(k))
    #     #         square = move.to_square
    #     #         squares.append(square)
    #     #         del new_table[move]
    #     return [bestMove.to_square]
    def update_no_piece_captured(self, playerColor):
