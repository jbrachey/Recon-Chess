...
if __name__ == '__main__':
    ...
    parser.add_argument('jbrachey3_jdill33_hghori6.py', help='Path to first bot source file.')
    ...
    name_one, constructor_one = load_player("jbrachey3_jdill33_hghori6.py")#args.first_path)
